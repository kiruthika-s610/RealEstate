...
const About = () => {
  ...
  return (
    <section id='about' className={`${darkmode ? 'dark bg-black' : 'light bg-transparent'} w-full m-auto lg:px-10 px-5 py-20 grid lg:grid-cols-1 justify-center items-center gap-10`}>
      <div>
      ...
      <div className='flex flex-col justify-center items-start gap-8'>
        ...
        <h1  data-aos='zoom-in' data-aos-delay="200" className='text-black text-[40px] font-semibold leading-10 dark:text-white'>Lorem ipsum dolor sit amet consectetur adipisicing elit. </h1>
          <div data-aos='zoom-in' data-aos-delay="200"  className='text-xl text-gray-600 dark:text-white text-justify' >
          ...
          <button className='bg-red-600 dark:bg-red-700 hover:bg-black text-white dark:hover:bg-white dark:hover:text-black font-semibold rounded-xl p-3 cursor-pointer transform hover:scale-110 transition-transform-duration-500'>Read more</button>
      </div>
    </section>
  )
}
