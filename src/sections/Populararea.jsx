...
const Populararea = () => {
  ...
  return (
    <div className={`${darkmode ? 'dark bg-black' : 'light bg-transparent'} `}>
      <section className={`${darkmode ? 'dark bg-gray-600' : 'light bg-orange-100 '} lg:w-[90%] w-full h-fit m-auto bg-center rounded-xl flex justify-center flex-col items-center lg:px-20 px-6 py-30 gap-20`}>
        <div id='top' className='w-full grid lg:grid-cols-6 grid-cols-1 justify-center items-center gap-8'>
          <div>
            ...
            <h1 data-aos="zoom-in" className='text-black text-[40px] font-semibold leading-15 mt-4 dark:text-white'>Explore most popular areas</h1>
          </div>
