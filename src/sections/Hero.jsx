  ...
  return (
    <>
      ...
      <div className={`${darkmode ? 'dark bg-black' : 'light bg-transparent'} z-10`}>
        <div data-aos="zoom-in" id='form' className={`${darkmode ? 'dark bg-gray-800' : 'light bg-white'} lg:w-[70%] w-full m-auto grid lg:grid-cols-4 grid-cols-1 p-8 -mt-14 rounded-xl pb-5 `}>
          location
        </div>
      </div>
    </>
