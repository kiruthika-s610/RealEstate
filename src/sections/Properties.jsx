...
import { FaBath,  FaBed, FaUserCircle,  FaMapMarkerAlt, FaVideo, FaCamera } from 'react-icons/fa'
            ...
            property.map((item, index) => (
              <div data-aos="zoom-in" data-aos-delay="200" key={index} className='bg-white  rounded-xl w-full '>
                ...
                <div className='px-6 py-5 flex-col items-start justify-center gap-2 w-full '>
                  <h1 className='text-xl m-1 text-stone-500 font-semibold'>
                    {item.name}
                  </h1>
                  <h1 className='text-2xl m-1 text-orange-600 font-bold '>
                    {item.price}
                  </h1>
